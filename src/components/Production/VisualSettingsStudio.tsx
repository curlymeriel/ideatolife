...
export const VisualSettingsStudio: React.FC<VisualSettingsStudioProps> = ({
    ...
    const [aiModel, setAiModel] = useState<'TURBO' | 'PRO' | 'STD'>('STD');
...
5. Provide a high-end cinematic description starting directly with the subject.`;
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const model = aiModel === 'TURBO' ? 'gemini-3.1-flash-image-preview' : aiModel === 'PRO' ? 'gemini-3-pro-image-preview' : 'gemini-2.5-flash-image';
