                ...
                <div className="space-y-3 max-h-[280px] overflow-y-auto pr-1 text-xs">
                    ...
                    <div className="bg-[var(--color-surface)] p-3 rounded border border-[var(--color-border)]">
                        ...
                        <div className="text-gray-400 space-y-1 text-[10px]">
                            ...
                            <p><strong className="text-gray-300">#2.</strong> <span className="text-blue-400">(Veo 영상 생성 사용시)</span> <a href="https://console.cloud.google.com/apis/library/aiplatform.googleapis.com" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] underline hover:text-orange-300">Google Cloud Console</a> 접속 → <strong className="text-white underline">Vertex AI API</strong> (또는 Vertex AI) → [사용함] 클릭 및 <strong>결제(카드) 연동 필수</strong></p>
